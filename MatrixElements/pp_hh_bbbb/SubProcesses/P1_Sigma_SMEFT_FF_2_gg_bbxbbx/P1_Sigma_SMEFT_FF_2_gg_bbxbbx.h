...
#include <Parameters_SMEFT_FF_2.h> 
...
class P1_Sigma_SMEFT_FF_2_gg_bbxbbx: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_SMEFT_FF_2_gg_bbxbbx(const ParameterSet& configuration); 
    virtual ~P1_Sigma_SMEFT_FF_2_gg_bbxbbx() {}; 
  ...
  private:
    ...
    P1_Sigma_SMEFT_FF_2_gg_bbxbbx() = delete; 
    ...
    // Matrix elements
    double matrix_1_gg_hh_h_bbx_h_bbx(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_SMEFT_FF_2_gg_bbxbbx >> > mapFinalStates;

    // Reference to the model parameters instance passed in the constructor
    std::shared_ptr < Parameters_SMEFT_FF_2 > params; 
