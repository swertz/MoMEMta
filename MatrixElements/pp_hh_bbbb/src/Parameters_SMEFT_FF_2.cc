...
// Constructor
Parameters_SMEFT_FF_2::Parameters_SMEFT_FF_2(const SLHA::Reader& card) 
{
...
void Parameters_SMEFT_FF_2::cacheParameters()
{
// Define "zero"
zero = 0; 
ZERO = 0; 
...
void Parameters_SMEFT_FF_2::cacheCouplings()
{
GC_28 = -6. * mdl_complexi * mdl_lam * mdl_vev; 
GC_31 = -((mdl_complexi * mdl_yb)/mdl_sqrt__2); 
}

void Parameters_SMEFT_FF_2::updateParameters()
{
