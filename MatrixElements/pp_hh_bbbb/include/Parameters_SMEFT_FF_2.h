...
class Reader;}
  ...
  class Parameters_SMEFT_FF_2: public momemta::MEParameters
  {

    public:

      Parameters_SMEFT_FF_2(const SLHA::Reader& card); 
      ...
      std::complex<double> GC_28, GC_31; 
      // Model couplings dependent on aS
      std::complex<double> GC_22, GC_34, GC_25; 
  }; 
